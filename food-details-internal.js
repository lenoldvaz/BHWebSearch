...
if (foodId) {
    ...
    food_url = new URL(` https://qiouzfzdc1.execute-api.ap-south-1.amazonaws.com/bh/food/details?food_item_id=${foodId}`)//URL(`https://toja6xsk7j.execute-api.ap-south-1.amazonaws.com/stage/food?food_item_id=${foodId}`); //URL(`https://bh.bonhappetee.com/food?food_item_id=${foodId}`);//
    ingredient_url = new URL(`https://qiouzfzdc1.execute-api.ap-south-1.amazonaws.com/bh/ingredients/detail?food_item_id=${foodId}`);//URL(`https://bh.bonhappetee.com/ingredients?food_item_id=${foodId}`);//
...
function getFoodDetails() {
  ...
  // request.setRequestHeader("x-api-key", "lIbF4IcMKv5N27HsfnRqx63VOjGhVKr72zIn3oCv");
