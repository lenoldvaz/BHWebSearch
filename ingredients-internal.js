    ...
    request.onload = function() {
        ...
        if (request.status >= 200 && request.status < 300) {
            ...
            let result = [];
                ...
                if(data.length === 0){
                    const ingredientsWrapper = document.querySelector('.ingredients-group-wrapper');
                    ingredientsWrapper.classList.add('hide');

                    const foodGroupWrapper = document.querySelector('.food-group-wrapper');
                    foodGroupWrapper.classList.add('hide');
                } else {
                    ...
                    function updateFoodGroups (foodGroups){
                        ...
                        for (const group of foodGroups ) {
                            ...
                            foodGroupDetDiv.classList.add('food-group-text-wrapper')
                                ...
                                foodGroupPropo.textContent = (group.proportion*100).toFixed(0)+'%';
