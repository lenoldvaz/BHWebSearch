...
if (foodId) {
    ...
    ingredient_url = new URL(`https://0l5jjp1ph8.execute-api.ap-south-1.amazonaws.com/bh/ingredients?id=${foodId}`);//URL(`https://bh.bonhappetee.com/ingredients?food_item_id=${foodId}`)//
