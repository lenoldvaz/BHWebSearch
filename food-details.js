...
if (foodId) {
    ...
    food_url = new URL(`https://0l5jjp1ph8.execute-api.ap-south-1.amazonaws.com/bh/food?food_item_id=${foodId}`); //URL(`https://bh.bonhappetee.com/food?food_item_id=${foodId}`);//
