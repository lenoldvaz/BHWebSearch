...
if (foodId) {
    ...
    food_url = new URL(`https://qiouzfzdc1.execute-api.ap-south-1.amazonaws.com/bh/food?food_item_id=${foodId}`); //URL(`https://bh.bonhappetee.com/food?food_item_id=${foodId}`);//
    ingredient_url = new URL(`https://qiouzfzdc1.execute-api.ap-south-1.amazonaws.com/bh/ingredients?id=${foodId}`);//URL(`https://bh.bonhappetee.com/ingredients?food_item_id=${foodId}`);//
