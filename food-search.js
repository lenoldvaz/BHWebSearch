...
function getFoodDetails() {
    ...
    request.setRequestHeader("x-api-key", "df821ac720b6cfca945e2a0f38afa360");
    ...
    request.onload = function() {
        ...
        if (request.status >= 200 && request.status < 400) {
            ...
            function updateBasicDetails() {
                ...
                // Check if data.food_tags is empty and add the 'hide' class to the foodTagsDiv element
                const foodTagsDiv = document.querySelector('.foodtagsdiv');
                if (Object.keys(data.food_tags).length === 0 && data.food_tags.constructor === Object) {
            ...
            window.energyKcalMeasure = energyKcalNutrient ? energyKcalNutrient.measure : 0;
            ...
            function createDonutChart(p,c,f,k) {
                ...
                var data = {
                    ...
                    datasets: [{
                        data: [p*100,c*100,f*100], // Values for each segment
                        
                        backgroundColor: ['#4C5EE7', '#907AD6', '#5299D3'], // Colors for each segment
                    }]
                };
                ...
                var options = {
                    ...
                    plugins: {
                        doughnutLabel: {
                            labels: [
                                {
                                    text: k.toString(), // Convert to string
                                    font: {
                                        size: 36, // Adjust the font size
                ...
                var myDonutChart = new Chart(ctx, {
                    ...
                    options: options, // Use the options defined earlier
                });

            }
            
            // Call this function with the widthValues you want
    ...
    if (pairings === undefined || pairings === null) {
        ...
        const divBlock10 = document.querySelector('.div-block-10');
        if (divBlock10) {
        ...
        updateNutriTableValues('FAMS', 'fams', 28)
        updateNutriTableValues('FAPU', 'fapu', 6)
        updateNutriTableValues('CHOLE', 'chole', 300)
        updateNutriTableValues('NA', 'na', 2000)
        updateNutriTableValues('FIBTG', 'fibtg', 30)
        ...
        createDonutChart(widthValueprotein,widthValuecarbs,widthValuefat,energyKcalMeasure)
