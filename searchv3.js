    ...
    request.onload = function () {
        if (request.status >= 200 && request.status < 400) {
            ...
            data.items.forEach(food => {
                ...
                const servingDetails = food.serving_size ? `${food.serving_size} ${food.serving_type}, ${food.calories_calculated_for.toFixed(0)}g` : `1  ${food.serving_type}, ${food.calories_calculated_for.toFixed(0)}g` ;
